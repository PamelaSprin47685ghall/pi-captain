...
export const riskAssessment: Step = {
  ...
  agent: "plan-reviewer",
  description: "Evaluate the chosen migration strategy and produce a go/no-go recommendation",
  prompt:
  ...
  gate: assert("output.includes('GO') || output.includes('Recommendation') || output.includes('recommendation')"),
  onFail: retry(2),
